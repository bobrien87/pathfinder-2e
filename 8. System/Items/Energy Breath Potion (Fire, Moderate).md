...
**Energy Breath** `pf2:1` You create a @Template[cone|distance:15] of fire which deals @Damage[6d6[fire]|options:area-damage] damage. All creatures in the area must attempt a DC 29 [[Reflex]] save.
