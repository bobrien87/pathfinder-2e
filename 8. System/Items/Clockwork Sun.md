...
**Destruction** A clockwork sun can be destroyed by mundane means, but its armored frame and high Hit Points make them difficult to damage. A clockwork sun reduced to 0 HP is destroyed and explodes in a blast of shrapnel and fire in a @Template[type:emanation|distance:40]. Creatures in the area take @Damage[10d6[piercing],10d6[fire]] damage (DC 43 [[Reflex]] save).
