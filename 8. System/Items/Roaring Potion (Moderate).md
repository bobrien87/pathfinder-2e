...
**Effect** You emit a scream in a @Template[cone|distance:15] that deals @Damage[6d4[sonic]|options:area-damage]. Each creature in the area can attempt a DC 30 [[Fortitude]] save saving throw.
