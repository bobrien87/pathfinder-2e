...
**Energy Breath** `pf2:1` You create a @Template[line|distance:30] of acid which deals @Damage[4d6[acid]|options:area-damage] damage. All creatures in the area must attempt a DC 23 [[Reflex]] save.
