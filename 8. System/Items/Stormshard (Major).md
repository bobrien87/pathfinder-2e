...
**Effect** You briefly release the spirits from the *stormshard* before drawing them back into the glass. Each creature in a @Template[type:emanation|distance:10] takes 13d8 void damage (DC 38 [[Fortitude]] save). You treat the result of your saving throw as one degree of success better than its outcome. You can choose to increase the radius of the emanation by up to 20 feet.
