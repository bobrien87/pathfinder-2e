...
**Energy Breath** `pf2:1` You create a @Template[cone|distance:15] of sound which deals @Damage[4d6[sonic]|options:area-damage] damage. All creatures in the area must attempt a DC 23 [[Fortitude]] save.
