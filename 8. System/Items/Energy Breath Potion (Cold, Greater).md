...
**Energy Breath** `pf2:1` You create a @Template[cone|distance:15] of cold which deals @Damage[10d6[cold]|options:area-damage] damage. All creatures in the area must attempt a DC 37 [[Reflex]] save.
