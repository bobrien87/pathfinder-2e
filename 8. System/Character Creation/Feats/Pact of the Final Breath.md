...
Additionally, the first time each day that you would be reduced to 0 Hit Points and gain the [[Dying]] condition, you instead regain a number of @Damage[(2*@actor.level)[healing]]{Hit Points equal to twice your level} (starting from 0 HP), remain conscious, and gain fast healing equal to your level for 3 rounds.

> [!danger] Effect: Pact of the Final Breath
