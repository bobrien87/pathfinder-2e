...
You can heal your wounds while reshaping your flesh. You regain @Damage[(max(1,floor(@actor.level/2)))d6[healing]]{1d6 Hit Points for every 2 levels you have} (minimum 1d6).
