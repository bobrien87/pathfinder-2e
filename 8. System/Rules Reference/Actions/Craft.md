...
You can make an item from raw materials. You need the [[Alchemical Crafting]] skill feat to create alchemical items and the [[Magical Crafting]] feat to create magic items.
