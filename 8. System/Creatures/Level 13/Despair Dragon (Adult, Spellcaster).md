...
armorclass:
  - name: AC
    desc: "33; **Fort** +21, **Ref** +23, **Will** +25"
health:
  - name: HP
    desc: "220; **Immunities** fear effects, paralyzed, sleep"
abilities_mid:
  - name: "+2 Status to All Saves vs. Occult"
    desc: ""
  - name: "Consume Fear"
    desc: "`pf2:r` **Trigger** A creature within 60 feet loses the frightened condition <br>  <br> **Effect** The dragon feasts upon the fear that leaves the triggering creature's body, gaining 5d8 temporary Hit Points that last for 1 minute."
  - name: "Frightful Presence"
    desc: "60 feet. DC 33 [[Will]] save <br>  <br> A creature that first enters the area must attempt a Will save. <br>  <br> Regardless of the result of the saving throw, the creature is temporarily immune to this monster's Frightful Presence for 1 minute. <br> - **Critical Success** The creature is unaffected by the presence. <br> - **Success** The creature is [[Frightened]] 1. <br> - **Failure** The creature is [[Frightened]] 2. <br> - **Critical Failure** The creature is [[Frightened]] 4."
...
attacks:
  - name: "Melee strike"
    desc: "Jaws +25 (`pf2:1`) (magical, reach 15 ft.), **Damage** 3d10+16 piercing"
  - name: "Melee strike"
    desc: "Claws +25 (`pf2:1`) (agile, magical, reach 10 ft.), **Damage** 3d8+16 slashing"
  - name: "Melee strike"
    desc: "Tail +23 (`pf2:1`) (magical, reach 20 ft.), **Damage** 3d6+14 bludgeoning"
spellcasting:
  - name: "Occult Prepared Spells"
    desc: "DC 33, attack +25<br>**6th** (2 slots) [[Mislead]], [[Phantasmal Calamity]]<br>**5th** (3 slots) [[Strange Geometry]], [[Synaptic Pulse]], [[Wave of Despair]]<br>**4th** (3 slots) [[Darkness]], [[Nightmare]], [[Detect Scrying]]<br>**3rd** (3 slots) [[Mind Reading]], [[Noise Blast]], [[Slow]]<br>**2nd** (3 slots) [[Paranoia]], [[Stupefy]], [[Ventriloquism]]<br>**1st** (3 slots) [[Command]], [[Ill Omen]], [[Sleep]]<br>**Cantrips** [[Detect Magic]], [[Figment]], [[Haunting Hymn]], [[Message]], [[Telekinetic Projectile]]"
  - name: "Occult Innate Spells"
    desc: "DC 33, attack +25<br>**5th** [[Truespeech]] (Constant)<br>**1st** [[Fear]] (At Will)"
abilities_bot:
  - name: "Shrieking Breath"
    desc: "`pf2:2` The dragon lets out a cacophonous sound made of every scream the dragon has drawn from a terrified enemy, dealing @Damage[12d6[sonic]|options:area-damage] damage in a @Template[type:cone|distance:40] (DC 33 [[Will]] save). Creatures who fail their Will save must spend the first action of their next turn doing nothing but screaming. The dragon can't use Shrieking Breath again for 1d4 rounds."
