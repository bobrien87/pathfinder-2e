...
abilities_top:
  - name: "Glutton's Feast"
    desc: "If the ogre glutton damages a living creature with their jaws Strike, they gain 1d4 temporary Hit Points for 1 minute. <br>  <br> > [!danger] Effect: Glutton's Feast"
armorclass:
  - name: AC
    desc: "18; **Fort** +14, **Ref** +7, **Will** +6"
health:
  - name: HP
    desc: "70"
abilities_mid: []
...
attacks:
  ...
  - name: "Melee strike"
    desc: "Jaws +14 (`pf2:1`) (unarmed), **Damage** 1d8+8 piercing plus [[Gluttons Feast]] plus [[Grab]]"
spellcasting: []
abilities_bot:
  - name: "Glutton's Rush"
