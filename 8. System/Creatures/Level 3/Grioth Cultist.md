...
perception:
  - name: Perception
    desc: "+10; [[Greater Darkvision]], [[Echolocation]] (precise) 20 feet"
...
abilities_top:
  ...
  - name: "Grioth Venom"
    desc: "**Saving Throw** DC 20 [[Fortitude]] save <br>  <br> **Maximum Duration** 6 rounds <br>  <br> **Stage 1** [[Frightened]] 1 (1 round) <br>  <br> **Stage 2** [[Frightened]] 2 (1 round) <br>  <br> **Stage 3** [[Frightened]] 3 (1 round)"
armorclass:
  - name: AC
    desc: "18; **Fort** +7, **Ref** +10, **Will** +10"
health:
  - name: HP
    desc: "40; **Immunities** cold; **Weaknesses** fire 5"
abilities_mid:
...
attacks:
  - name: "Melee strike"
    desc: "Kukri +10 (`pf2:1`) (agile, finesse, trip), **Damage** 1d6 + 2 slashing"
  - name: "Melee strike"
    desc: "Jaws +10 (`pf2:1`) (agile, finesse, unarmed), **Damage** 1d8 + 2 piercing plus [[Grioth Venom]]"
spellcasting:
  - name: "Divine Prepared Spells"
    desc: "DC 20, attack +12<br>**2nd** (3 slots) [[Dispel Magic]], [[Heal]], [[Noise Blast]]<br>**1st** (4 slots) [[Fear]], [[Harm]], [[Heal]], [[Ventriloquism]]<br>**Cantrips** [[Divine Lance]], [[Forbidding Ward]], [[Message]], [[Prestidigitation]], [[Stabilize]]"
  - name: "Occult Innate Spells"
    desc: "DC 19, attack +11<br>**1st** [[Daze]], [[Detect Magic]], [[Phantom Pain]], [[Telekinetic Hand]], [[Telekinetic Projectile]]"
abilities_bot:
  - name: "Invoke Haunter of the Dark"
    desc: "`pf2:2` **Frequency** once per day <br>  <br> **Effect** The grioth cultist waves a hand in a complex pattern to invoke dark powers, dealing @Damage[3d8[mental]|options:area-damage] damage. Each non-grioth creature within @Template[emanation|distance:20]{20 feet} must attempt a DC 20 [[Will]] save. <br> - **Critical Success** The creature is unaffected. <br> - **Success** The creature takes half damage <br> - **Failure** The creature takes full damage and becomes [[Stupefied 1]] for 1 round <br> - **Critical Failure** The creature takes double damage and becomes stupefied 1 for 1 minute."
  - name: "Shock Mind"
    desc: "`pf2:2` The grioth cultist makes a Strike with a voidglass weapon. <br>  <br> If the Strike hits, it deals an additional 2d6 mental damage, and the target must succeed at a DC 20 [[Will]] save (this has the incapacitation trait) or become [[Confused]] for 1 round."
