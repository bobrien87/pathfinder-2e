...
attacks:
  - name: "Melee strike"
    desc: "Antler +12 (`pf2:1`), **Damage** 1d10+7 piercing"
  - name: "Melee strike"
    desc: "Hoof +12 (`pf2:1`), **Damage** 1d8+7 bludgeoning"
spellcasting: []
abilities_bot:
  - name: "Kick Back"
    desc: "`pf2:1` The moose bucks and kicks back with both hind hooves, making a Strike with a -2 circumstance penalty to the attack roll. If it hits, it deals an extra 1d8 bludgeoning damage. <br>  <br> This counts as two attacks when calculating the moose's multiple attack penalty."
  - name: "Thundering Charge"
    desc: "`pf2:2` The moose Strides twice and then makes an antler Strike. A Medium or smaller creature damaged by this attack must succeed at a DC 18 [[Fortitude]] save or be [[Stunned]] 1."
  - name: "Trample"
