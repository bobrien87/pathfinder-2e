...
armorclass:
  - name: AC
    desc: "18; **Fort** +11, **Ref** +9, **Will** +6"
health:
  - name: HP
    desc: "54; **Weaknesses** area damage 5, splash damage 5"
abilities_mid:
  - name: "Troop Defenses"
...
abilities_bot:
  - name: "Indiscriminate Assault"
    desc: "`pf2:1` `pf2:1` to `pf2:3` <br>  <br> **Frequency** once per round <br>  <br> **Effect** The conscript squad lashes out at each other creature in a @Template[type:emanation|distance:5], friend and foe, with a DC 17 [[Reflex]] save. The damage depends on the number of actions. <br>  <br> `pf2:1` @Damage[1d8[piercing]|options:area-damage] damage <br>  <br> `pf2:2` @Damage[(1d8+4)[piercing]|options:area-damage] damage <br>  <br> `pf2:3` @Damage[(2d8+4)[piercing]|options:area-damage] damage"
sourcebook: "NPC Core"
