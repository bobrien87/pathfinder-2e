...
spellcasting:
  - name: "Occult Prepared Spells"
    desc: "DC 30, attack +22<br>**5th** (2 slots) [[Locate]], [[Wave of Despair]]<br>**4th** (3 slots) [[Clairvoyance]], [[Confusion]], [[Read Omens]]<br>**3rd** (3 slots) [[Dream Message]], [[Hypercognition]], [[Locate]]<br>**2nd** (3 slots) [[Clear Mind]], [[Status]], [[Stupefy]]<br>**1st** (3 slots) [[Command]], [[Fear]], [[Protection]]<br>**Cantrips** [[Daze]], [[Detect Magic]], [[Know the Way]], [[Message]], [[Read Aura]]"
...
```statblock
creature: "Omen Dragon (Adult, Spellcaster)"
```
