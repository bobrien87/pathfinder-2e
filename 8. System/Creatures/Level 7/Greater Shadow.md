...
armorclass:
  - name: AC
    desc: "24; **Fort** +11, **Ref** +18, **Will** +15"
health:
  - name: HP
    desc: "75; void healing; **Immunities** death effects, disease, paralyzed, poison, precision, unconscious, bleed; **Resistances** all damage 10 except force, ghost touch, vitality, spirit"
abilities_mid:
...
attacks:
  - name: "Melee strike"
    desc: "Shadow Hand +18 (`pf2:1`) (finesse, magical), **Damage** 2d10+6 void"
spellcasting:
  - name: "Divine Innate Spells"
    desc: "DC 25, attack +17<br>**2nd** [[Darkness]]"
abilities_bot:
  - name: "Steal Shadow"
