...
abilities_top:
  ...
  - name: "Sinful Bite"
    desc: "A creature hit by the jaws of a sinspawn must attempt a DC 18 [[Will]] save as it is assailed by sinful thoughts. <br> - **Critical Success** Unaffected <br> - **Success** [[Sickened]] 1 <br> - **Failure** [[Sickened]] 2 <br> - **Critical Failure** sickened 2 plus –10-foot status penalty to their Speeds for 1 minute <br>  <br> > [!danger] Effect: Sinful Bite"
armorclass:
  - name: AC
...
attacks:
  ...
  - name: "Melee strike"
    desc: "Longspear +10 (`pf2:1`) (reach 10 ft.), **Damage** 1d8+4 piercing"
spellcasting: []
abilities_bot: []
