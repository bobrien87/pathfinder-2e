...
skills:
  - name: Skills
    desc: "Athletics +12, Nature +13, Survival +11"
abilityMods: ["+4", "+2", "+4", "+1", "+2", "+2"]
abilities_top: []
armorclass:
  - name: AC
    desc: "20; **Fort** +15, **Ref** +9, **Will** +11"
health:
  - name: HP
    desc: "90"
abilities_mid:
  - name: "Death Flood"
    desc: "When a grodair dies, its body explodes in a blast of pressurized water that deals @Damage[4d6[bludgeoning]|options:area-damage] damage to creatures within a @Template[emanation|distance:15] (DC 22 [[Reflex]] save). A creature that fails its save is pushed 5 feet (or 10 feet on a critical failure)."
speed: "0 feet"
attacks:
  - name: "Melee strike"
    desc: "Jaws +15 (`pf2:1`) (unarmed), **Damage** 2d8+7 piercing"
  - name: "Melee strike"
    desc: "Tentacle +15 (`pf2:1`) (unarmed), **Damage** 1d10+7 bludgeoning plus [[Knockdown]]"
  - name: "Ranged strike"
    desc: "Water Jet +13 (`pf2:1`) (range 60 ft.), **Damage** 3d6 bludgeoning plus [[Push]]"
spellcasting:
  - name: "Primal Innate Spells"
    desc: "DC 22, attack +0<br>**5th** [[Control Water]]"
abilities_bot:
  - name: "Muddy Field"
    desc: "`pf2:1` The grodair transforms all soil, sand, or similar sediment in a @Template[emanation|distance:10] into mud for 1 round. This mud is difficult terrain for creatures other than grodairs."
  - name: "Organ of Endless Water"
    desc: "`pf2:1` The grodair causes water to pour from a magical sac on its spine, either a stream of water at a rate of 1 gallon per round, or a fountain in a 5-foot-long stream at a rate of 5 gallons per round. It can stop the flow of water as a single action."
  - name: "Push 10 feet"
