...
armorclass:
  - name: AC
    desc: "21; **Fort** +11, **Ref** +14, **Will** +8"
health:
  - name: HP
    desc: "75; Thresholds 50 (3 segments), 25 (2 segments); **Weaknesses** area damage 5, splash damage 5"
abilities_mid:
  - name: "Troop Defenses"
...
abilities_bot:
  - name: "Bites and Talons"
    desc: "`pf2:1` **Frequency** once per round <br>  <br> **Effect** The pack makes a melee attack against each enemy in a @Template[type:emanation|distance:5] (DC 19 [[Reflex]] save). The damage depends on the number of actions. <br>  <br> `pf2:1` @Damage[1d6[piercing],1d4[precision]]{1d6 piercing or slashing damage and 1d4 precision damage} <br>  <br> `pf2:2` @Damage[2d6[piercing],2d4[precision]]{2d6 piercing or slashing damage and 2d4 precision damage} <br>  <br> `pf2:3` @Damage[3d6[piercing],2d4[precision]]{3d6 piercing or slashing damage and 2d4 precision damage}"
  - name: "Raptor Leap"
    desc: "`pf2:1` **Frequency** once per round <br>  <br> **Effect** The pack Strides, ignoring difficult terrain (but not greater difficult terrain). At the end of this movement, each enemy in a @Template[type:emanation|distance:5] takes 1d8 piercing (DC 19 [[Reflex]] save)."
