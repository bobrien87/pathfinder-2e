...
perception:
  - name: Perception
    desc: "+29; [[Darkvision]], [[Lifesense]] (imprecise) 90 feet, [[Scent]] (imprecise) 60 feet"
...
armorclass:
  - name: AC
    desc: "36; **Fort** +26, **Ref** +23, **Will** +29"
health:
  - name: HP
    desc: "270; **Immunities** death effects, paralyzed, sleep"
abilities_mid:
  - name: "Soul Anchor"
  ...
  - name: "Withhold Death"
    desc: "`pf2:r` **Trigger** The dragon is critically hit by an attack <br>  <br> **Effect** The dragon resists the loosening of its own soul, preventing some of the damage. The dragon gains resistance 15 to all damage against the triggering attack."
speed: "0 feet"
attacks:
  - name: "Melee strike"
    desc: "Horn +30 (`pf2:1`) (magical, reach 15 ft.), **Damage** 3d10+12 piercing plus 2d8 spirit"
  - name: "Melee strike"
    desc: "Claw +30 (`pf2:1`) (agile, magical, reach 10 ft.), **Damage** 3d6+12 slashing plus 2d8 spirit plus [[Grab]]"
  - name: "Melee strike"
    desc: "Tail +28 (`pf2:1`) (magical, reach 20 ft.), **Damage** 3d8+12 bludgeoning plus 2d8 spirit"
spellcasting:
  - name: "Divine Prepared Spells"
    desc: "DC 36, attack +28<br>**6th** (3 slots) [[Field of Life]], [[Raise Dead]], [[Vital Beacon]]<br>**5th** (3 slots) [[Banishment]], [[Breath of Life]], [[Invoke Spirits]]<br>**4th** (3 slots) [[Ghostly Tragedy]], [[Talking Corpse]], [[Vital Beacon]]<br>**3rd** (3 slots) [[Protection]], [[Ring of Truth]], [[Safe Passage]]<br>**2nd** (3 slots) [[See the Unseen]], [[Share Life]], [[Thoughtful Gift]]<br>**1st** (3 slots) [[Protection]], [[Sanctuary]], [[Spirit Link]]<br>**Cantrips** [[Guidance]], [[Haunting Hymn]], [[Message]], [[Sigil]], [[Stabilize]]"
  - name: "Divine Innate Spells"
    desc: "DC 33, attack +0<br>**1st** [[Heal]], [[Heal]], [[Stabilize]]"
abilities_bot:
  - name: "Dooming Breath"
    desc: "`pf2:2` Energy from Creation's Forge erupts from the dragon's mouth, dealing @Damage[12d8[spirit]|options:area-damage] damage in a @Template[type:line|distance:90] (DC 36 [[Reflex]] save). Undead creatures who fail the save must also succeed at a DC 36 [[Will]] save or become [[Doomed]] 1. If the target is already doomed, the doomed value increases by 1 (to a maximum of [[Doomed]] 4). The dragon can't use Dooming Breath again for 1d4 rounds."
  - name: "Soul Shield"
