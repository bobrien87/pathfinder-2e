...
abilities_top:
  - name: "Sandstorm Sight"
    desc: "Sandstorms don't impair a desert drake's vision; they ignore [[Concealment]] from sandstorms. They also are immune to being [[Dazzled]] or [[Blinded]] by sand or other grit."
...
armorclass:
  - name: AC
    desc: "27; **Fort** +17, **Ref** +15, **Will** +13"
health:
  - name: HP
    desc: "135; **Immunities** paralyzed, sleep; **Resistances** cold 10, fire 10"
abilities_mid:
  - name: "Wing Deflection"
    desc: "`pf2:r` **Trigger** The desert drake is targeted with an attack <br>  <br> **Effect** The desert drake raises their wing, gaining a +2 circumstance bonus to AC against the triggering attack. If the desert drake is flying at the time they're attacked, they descend 10 feet after the attack is complete."
speed: "0 feet"
attacks:
  - name: "Melee strike"
    desc: "Fangs +19 (`pf2:1`), **Damage** 2d12+10 piercing"
  - name: "Melee strike"
    desc: "Tail +19 (`pf2:1`) (reach 10 ft.), **Damage** 2d10+10 bludgeoning plus [[Push]]"
spellcasting: []
abilities_bot:
  - name: "Draconic Frenzy"
    desc: "`pf2:2` The desert drake makes two Fangs Strikes and one Tail Strike in any order."
  - name: "Sandstorm Breath"
    desc: "`pf2:2` The desert drake spits a ball of abrasive sand with a range of 60 feet that explodes into a cloud with a @Template[burst|distance:15]. Creatures in the area take @Damage[9d6[slashing]|options:area-damage] damage (DC 27 [[Reflex]] save). <br>  <br> The desert drake can't use Sandstorm Breath again for 1d6 rounds, during which the sandstorm lingers in the area. This lingering sandstorm grants [[Concealment]] to everything within it and conceals everything outside from them."
  - name: "Speed Surge"
    desc: "`pf2:1` **Frequency** three times per day <br>  <br> **Effect** The desert drake Strides or Flies twice."
  - name: "Push"
