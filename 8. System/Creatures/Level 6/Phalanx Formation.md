...
abilities_bot:
  - name: "Hurl Javelins"
    desc: "`pf2:2` The troop's members throw a volley of spears. Each creature in a @Template[type:burst|distance:10] within 30 feet of the troop takes @Damage[(2d6+5)[piercing]|options:area-damage] damage with a DC 21 [[Reflex]] save. When the phalanx formation is reduced to 2 or fewer segments, this area decreases to a @Template[type:burst|distance:5]."
  - name: "Shields Up!"
  ...
  - name: "Spears Out!"
    desc: "`pf2:1` `pf2:1` to `pf2:3` <br>  <br> **Frequency** once per round <br>  <br> **Effect** The phalanx formation thrusts their longspears out in all directions, striking all unfortunate enough to be near them. Each enemy in a @Template[type:emanation|distance:10] must attempt a DC 21 [[Reflex]] save. <br>  <br> The damage depends on the number of actions. <br>  <br> `pf2:1` @Damage[(1d8+2)[piercing]|options:area-damage] damage <br>  <br> `pf2:2` @Damage[(2d8+5)[piercing]|options:area-damage] damage <br>  <br> `pf2:3` @Damage[(3d8+5)[piercing]|options:area-damage] damage"
sourcebook: "NPC Core"
