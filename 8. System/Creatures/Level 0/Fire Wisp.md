...
armorclass:
  - name: AC
    desc: "15; **Fort** +6, **Ref** +7, **Will** +4"
health:
  - name: HP
    desc: "15; **Immunities** bleed, paralyzed, poison, sleep, fire; **Weaknesses** cold 2, water 2"
abilities_mid:
  - name: "Accord Essence"
...
attacks:
  - name: "Melee strike"
    desc: "Tendril +6 (`pf2:1`) (reach 10 ft.), **Damage** 1d4+1 fire plus 1 fire"
spellcasting: []
abilities_bot: []
