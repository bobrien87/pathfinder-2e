...
armorclass:
  - name: AC
    desc: "13; **Fort** +8, **Ref** +4, **Will** +4"
health:
  - name: HP
    desc: "20; **Immunities** bleed, paralyzed, poison, sleep; **Resistances** fire 2"
abilities_mid:
  - name: "Accord Essence"
...
abilities_bot:
  - name: "Drench"
    desc: "`pf2:1` The wisp puts out all fires in a single 5-foot square. They extinguish non-magical fire of that size or smaller automatically and attempt to counteract magical fires (counteract modifier +6)."
