...
armorclass:
  - name: AC
    desc: "40; **Fort** +27, **Ref** +28, **Will** +32"
health:
  - name: HP
    desc: "345; **Immunities** controlled, paralyzed, sleep"
abilities_mid:
...
attacks:
  - name: "Melee strike"
    desc: "Jaws +32 (`pf2:1`) (magical, reach 15 ft., unarmed), **Damage** 3d8+17 piercing"
  - name: "Melee strike"
    desc: "Claw +32 (`pf2:1`) (agile, magical, reach 10 ft., unarmed), **Damage** 3d6+17 slashing"
  - name: "Melee strike"
    desc: "Tail +30 (`pf2:1`) (magical, reach 20 ft.), **Damage** 2d10+17 bludgeoning"
  - name: "Ranged strike"
    desc: "Mental Blast +31 (`pf2:1`) (mental), **Damage** 6d6+6 mental"
spellcasting:
  - name: "Occult Prepared Spells"
    desc: "DC 39, attack +31<br>**8th** (2 slots) [[Hidden Mind]], [[Unrelenting Observation]]<br>**7th** (3 slots) [[Duplicate Foe]], [[Project Image]], [[Warp Mind]]<br>**6th** (3 slots) [[Mislead]], [[Scrying]], [[Truesight]]<br>**5th** (3 slots) [[Scouting Eye]], [[Synaptic Pulse]], [[Truespeech]]<br>**4th** (3 slots) [[Clairvoyance]], [[Honeyed Words]], [[Suggestion]]<br>**3rd** (3 slots) [[Clairaudience]], [[Paralyze]], [[Veil of Privacy]]<br>**2nd** (3 slots) [[Calm]], [[Invisibility]], [[Paranoia]]<br>**1st** (3 slots) [[Bane]], [[Fear]], [[Phantom Pain]]<br>**Cantrips** [[Daze]], [[Detect Magic]], [[Figment]], [[Message]], [[Telekinetic Projectile]]"
  - name: "Occult Innate Spells"
    desc: "DC 41, attack +33<br>**6th** [[Dominate]]<br>**5th** [[Mind Probe]]<br>**4th** [[Rewrite Memory]], [[Rewrite Memory]] (At Will)<br>**3rd** [[Mind Reading]] (At Will)<br>**1st** [[Charm]] (At Will)"
abilities_bot:
  - name: "Detonate Disguise"
    desc: "`pf2:2` **Requirements** The dragon is wearing their conjured disguise <br>  <br> **Effect** The dragon erupts from the disguise, destroying it. The explosive revelation deals @Damage[18d6[bludgeoning]|options:area-damage] damage to creatures in a @Template[emanation|distance:5] with a DC 39 [[Reflex]] save. A creature that fails its save is [[Dazzled]] for 1 round as it becomes covered in scraps from the disguise. <br>  <br> Any creature sharing a space with the dragon after they erupt is pushed into the nearest empty space."
  ...
  - name: "Smoke Breath"
    desc: "`pf2:2` The dragon unleashes a noxious cloud of smoke that deals @Damage[16d6[poison]|options:area-damage] damage in a @Template[cone|distance:60] (DC 39 [[Fortitude]] save). The smoke remains for 1 minute. This has the effects of [[Mist]], except it fills the cone's area. <br>  <br> The dragon can't use Smoke Breath again for 1d4 rounds."
...
```statblock
creature: "Conspirator Dragon (Ancient, Spellcaster)"
```
