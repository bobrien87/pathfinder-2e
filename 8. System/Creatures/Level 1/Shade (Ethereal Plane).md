...
skills:
  - name: Skills
    desc: "Athletics +7, Ethereal Plane Lore +7"
abilityMods: ["+2", "+2", "+2", "+2", "+2", "+2"]
abilities_top:
  - name: "Planar Incarnation - Ethereal Plane (The Terrorized)"
    desc: "All shades are formed from and personify the nature of the plane on which they manifest, and their statistics are adjusted as summarized below. They also gain any trait associated with creatures from their plane. <br>  <br> **Ethereal Plane (The Terrorized)** The terrorized appear as sickly, haunted-looking versions of their mortal selves. <br>  <br> - **Language** any one spoken in life (such as Common) <br> - **Additional Ability** immune to bleed and death effects <br> - **Melee** fist +7, **Damage** 1d8+2 bludgeoning"
armorclass:
  - name: AC
    desc: "15; **Fort** +7, **Ref** +7, **Will** +7"
health:
  - name: HP
    desc: "22; **Immunities** bleed, death effects"
abilities_mid: []
speed: "0 feet"
attacks:
  - name: "Melee strike"
