...
perception:
  - name: Perception
    desc: "+21; [[Darkvision]], [[Magicsense]] (imprecise) 60 feet, [[Scent]] (imprecise) 60 feet"
languages: "Common, Draconic (Five additional common languages)"
skills:
  - name: Skills
    desc: "Acrobatics +19, Arcana +23, Athletics +21, Crafting +21, Diplomacy +18, Performance +20, Society +19, Survival +19, Linguistics Lore +21, Rune Lore +23"
...
armorclass:
  - name: AC
    desc: "30; **Fort** +19, **Ref** +17, **Will** +21"
health:
  - name: HP
    desc: "175; **Immunities** paralyzed, sleep"
abilities_mid:
...
attacks:
  - name: "Melee strike"
    desc: "Claw +22 (`pf2:1`) (agile, magical), **Damage** 2d6+10 slashing plus [[Detonating Rune]]"
  - name: "Melee strike"
    desc: "Jaws +22 (`pf2:1`) (magical, reach 10 ft.), **Damage** 2d6+10 piercing plus [[Detonating Rune]]"
  - name: "Melee strike"
    desc: "Tail +20 (`pf2:1`) (magical, reach 15 ft.), **Damage** 2d10+10 bludgeoning plus [[Push]]"
spellcasting:
  - name: "Arcane Prepared Spells"
    desc: "DC 29, attack +21<br>**4th** (3 slots) [[Dispel Magic]], [[Translate]], [[Wall of Fire]]<br>**3rd** (3 slots) [[Fireball]], [[Gravity Well]], [[Veil of Privacy]]<br>**2nd** (3 slots) [[Blur]], [[Embed Message]], [[Translate]]<br>**1st** (3 slots) [[Alarm]], [[Fear]], [[Gust of Wind]]<br>**Cantrips** [[Detect Magic]], [[Ignition]], [[Message]], [[Sigil]], [[Telekinetic Hand]]"
abilities_bot:
  - name: "Runic Breath"
    desc: "`pf2:2` The dragon launches hundreds of exploding runes that detonate upon impact, dealing @Damage[9d6[untyped]|options:area-damage] damage in a @Template[type:cone|distance:30] (DC 29 [[Reflex]] save). The damage type of this ability is determined by Shifting Rune. Creatures who fail the save are also affected by detonating rune. The dragon can't use Runic Breath again for 1d4 rounds."
  - name: "Shifting Runes"
