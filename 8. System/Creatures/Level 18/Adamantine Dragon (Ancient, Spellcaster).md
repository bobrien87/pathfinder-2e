...
armorclass:
  - name: AC
    desc: "41; **Fort** +32, **Ref** +26, **Will** +29"
health:
  - name: HP
    desc: "300; **Immunities** paralyzed, petrified, sleep"
abilities_mid:
  ...
  - name: "Fast Swallow"
    desc: "`pf2:r` **Trigger** The dragon Grabs a creature <br>  <br> **Effect** The dragon uses Swallow Whole."
  - name: "Improved Grab"
...
attacks:
  - name: "Melee strike"
    desc: "Jaws +36 (`pf2:1`) (magical, reach 20 ft., unarmed), **Damage** 3d12+18 piercing plus [[Improved Grab]]"
  - name: "Melee strike"
    desc: "Claw +36 (`pf2:1`) (agile, magical, reach 15 ft., unarmed), **Damage** 3d8+18 slashing plus [[Knockdown]]"
  - name: "Melee strike"
    desc: "Tail +34 (`pf2:1`) (magical, reach 25 ft.), **Damage** 3d10+18 bludgeoning"
  - name: "Ranged strike"
    desc: "Rock +34 (`pf2:1`) (brutal, range 150 ft.), **Damage** 3d8+18 bludgeoning"
spellcasting:
  - name: "Primal Prepared Spells"
    desc: "DC 41, attack +36<br>**8th** (3 slots) [[Desiccate]], [[Earthquake]], [[Moment of Renewal]]<br>**7th** (3 slots) [[Mask of Terror]], [[Regenerate]], [[Volcanic Eruption]]<br>**6th** (3 slots) [[Field of Life]], [[Petrify]], [[Tangling Creepers]]<br>**5th** (3 slots) [[Impaling Spike]], [[Magic Passage]], [[Speak with Stones]]<br>**4th** (3 slots) [[Shape Stone]], [[Unfettered Movement]], [[Vapor Form]]<br>**3rd** (3 slots) [[Earthbind]], [[One with Stone]], [[Slow]]<br>**2nd** (3 slots) [[Darkness]], [[Shatter]], [[Water Walk]]<br>**1st** (3 slots) [[Air Bubble]], [[Tailwind]], [[Vanishing Tracks]]<br>**Cantrips** [[Caustic Blast]], [[Detect Magic]], [[Know the Way]], [[Sigil]], [[Tangle Vine]]"
abilities_bot:
  - name: "Avalanche Breath"
    desc: "`pf2:2` The dragon belches a mass of boulders that deals @Damage[15d8[bludgeoning]|options:area-damage] damage in a @Template[cone|distance:40] (DC 40 [[Reflex]] save). <br>  <br> They can't use Avalanche Breath again for 1d4 rounds."
...
```statblock
creature: "Adamantine Dragon (Ancient, Spellcaster)"
```
